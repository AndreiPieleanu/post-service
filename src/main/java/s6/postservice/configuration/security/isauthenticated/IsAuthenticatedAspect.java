package s6.postservice.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(s6.postservice.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(s6.postservice.configuration.security.isauthenticated.IsAuthenticated)")
